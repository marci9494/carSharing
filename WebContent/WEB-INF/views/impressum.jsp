...
<p>I. Allgemeines
Für mit Kunden (nachfolgend „Mieter“ genannt) abgeschlossene Verträge sowie im Rahmen dieser Verträge erbrachten Leistungen gelten nur die nachfolgenden allgemeinen Vermietbedingungen, sofern nicht im Einzelfall individuelle Abweichungen vereinbart werden.Bedingungen des Mieters, auch soweit sie Gegenstand einer Auftragsbestätigung sind, sind nicht gültig, auch wenn im Einzelfall nicht ausdrücklich widersprochen wurde.
...
b) wenn vereinbart, Gebühren für die Vollkaskoversicherung, die lnsassenunfallversicherung sowie die Eintragung weiterer Fahrer, sowie gegebenenfalls Rückführungsgebühren;
c) alle auf die Positionen a) bis c) erhobenen Steuern sowie alle im Zusammenhang mit der Benutzung des Fahrzeuges anfallenden Gebühren, Abgaben, Bußgelder und Strafen, für die der Vermieter in Anspruch genommen wird, es sei denn, sie sind auf Verschulden des Vermieters zurückzuführen;
d) alle Kosten, die dem Vermieter durch die Eintreibung von fälligen Forderungen gegen den Mieter entstehen. Der Vermieter kann vor Übergabe des Kfz eine Vorauszahlung bis zur Höhe einer Monatsmiete, mindestens jedoch 100,- EUR verlangen.
III. Versicherung
1. Für das Kfz bestehen folgende Versicherungen nach den Allgemeinen Kraftfahrzeugversicherungsbedingungen.
(AKB): Haftpflichtversicherung, auf Anfrage Teilkaskoversicherung mit Selbstbeteiligung. Fahrer, Fahrzeug, Insassen, Gepäck, Waren usw. sind nicht versichert.
...
2. Der Mieter ist zu einer Aufrechnung nur berechtigt, wenn seine Forderungen unbestritten, entscheidungsreif oder rechtskräftig festgestellt sind. Dies gilt nicht für Ansprüche aus Schadensersatz wegen eines Mangels der Mietsache (§ 536a BGB) und für Rückforderungsansprüche wegen zuviel gezahlter Miete.
